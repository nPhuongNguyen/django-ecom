    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('option', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                              related_name='values', to='core.option')),
            ],
        ),
        migrations.CreateModel(
            name='Product',
            fields=[
                ...
                ('category', models.ForeignKey(blank=True, null=True,
                                                on_delete=django.db.models.deletion.PROTECT,
                                                  related_name='products', to='core.category')),
                ('collection', models.ManyToManyField(blank=True, related_name='products',
                                                       to='core.collection')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                               related_name='variants', to='core.product')),
            ],
        ),
        migrations.CreateModel(
            name='Voucher',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('end_date', models.DateTimeField(null=True)),
                ('is_activate', models.BooleanField(default=True)),
                ('category', models.ManyToManyField(blank=True, related_name='promotions',
                                                     to='core.category')),
                ('collection', models.ManyToManyField(blank=True, related_name='promotions',
                                                       to='core.collection')),
                ('product', models.ManyToManyField(blank=True, related_name='promotions',
                                                    to='core.product')),
            ],
        ),
    ]
