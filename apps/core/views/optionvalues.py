...
class OptionValueView(APIView):
    ...
    def post(self, request):
        ...
        option_vlue = OptionValueService.create_option_value(serializer)
    ...
    def get(self, request, id=None):
        if id:
            ...
            if not option_value:
                return Response({
                    "statusCode": 0,
                    "message": "Option Value không tồn tại!",
                    "data": None
                })
            return Response({
                "statusCode": 1,
    ...
    def put(self, request, id, *args, **kwargs):
        ...
        return Response({
            "statusCode": 1,
            "message": "Cập nhật Option Value thành công",
            "data": option_value
        })
    @catch_exceptions
    def delete(self, request, id, *args, **kwargs):
        ...
        return Response({
            "statusCode": 1,
            "message": "Xóa Option Value thành công",
            "data": []
        })
